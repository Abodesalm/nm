...
const TYPE_LABELS: Record<string, string> = {
  ...
  item_unhidden: "إظهار عنصر",
  item_deleted: "حذف عنصر",
  action_deleted: "حذف حركة",
  bonus_added: "إضافة مكافأة",
  hr_points_added: "إضافة نقاط تقييم",
  absent_marked: "تسجيل حضور/غياب",
  absent_edited: "تعديل حضور/غياب",
  absent_deleted: "حذف سجل حضور/غياب",
  hr_points_deleted: "حذف نقاط تقييم",
  treasury_deposit: "دخل في الخزينة",
  treasury_withdraw: "خرج من الخزينة",
  treasury_entry_deleted: "حذف حركة خزينة",
  fund_changed: "تعديل الصناديق",
